 ...
 * Typically this may include alerts, turning off things (to avoid hard off), or disconnecting HV
 * parts Don't forget to feed the WDT to avoid a reset!
 */
...
int main() {
	...
	while (!shutdown) {
		...
		// other functions that rely on timing.
		bool overflow;
